...
export function gotAllTasksAction(tasks: CustomerModel[]): TaskAction {
    return {
...
export function gotSingleTaskAction(task: CustomerModel): TaskAction {
    return {
...
export function addedTaskAction(task: CustomerModel): TaskAction {
    return {
...
export function updatedTaskACtion(task: CustomerModel): TaskAction {
    return {
